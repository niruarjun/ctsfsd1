...
public class Todo {
	private Task1 task;
	private RandomFortune fortuneSeervice;
	//private RandomFortuneSeervice fortuneSeervice;
	private String todoId;
	private LocalDate date;
	private boolean isCompleted;

	public Todo(Task1 task, RandomFortune fortuneSeervice) {
//	public Todo(Task1 task /*RandomFortuneSeervice fortuneSeervice*/) {
...
/*		if(fortune==null)
		...
		System.out.println("Your Daily Fortune>>> "+fortune.getDailyFortune());
		
	public Todo createTodo1(String author, String taskName, boolean isCompleted) {
		/*
